...
| **Supabase Auth** | Apps already using Supabase for DB | Low if already on Supabase | Included in Supabase free tier | Couples auth to Supabase; requires replacing PostgreSQL + EF Core |
